    ...
    (function (shikhar) {
        ...
        class Gui {
            constructor(component) {
                ...
                if (this.c_gradient1 === undefined) {
                    this.c_gradient1 = null;
                }
                if (this.c_gradient2 === undefined) {
                    this.c_gradient2 = null;
                }
                ...
                this.activeTimer.setCallback(this);
                this.setDefaultFont(new org.shikhar.Font("15px Arial", this.g.context));
                this.setColors$int_A(Gui.SANDSTONE_THEME_$LI$());
                this.reset();
            }
            ...
            reset() {
                ...
                this.block = this.font.getHeight();
            ...
            setColors$int$int$int$int$int$int$int$int$int$int(background, text, textbackground, border, disable, hover, press, focus, select, iconTintColor) {
                ...
                this.c_gradient1 = new org.shikhar.Color(this.c_bg.r, this.c_bg.g, this.c_bg.b, Math.fround((Math.fround(this.c_bg.a + 1)) / 2));
                this.c_gradient2 = new org.shikhar.Color(this.c_press.r, this.c_press.g, this.c_press.b, Math.fround((Math.fround(this.c_press.a + 1)) / 2));
            ...
            render() {
                if (Gui.repaintNeeded || true) {
                    ...
                    this.g.begin(this.width, this.height, true);
                    this.paint$();
                    this.g.end();
                }
                else {
                    this.g.setFont(this.font);
                    this.g.begin(this.width, this.height, false);
                    for (let index = this.beans.iterator(); index.hasNext();) {
                        let bean = index.next();
                        {
                            this.renderComp(bean);
                        }
                    }
                    this.g.end();
                }
            ...
            paint$int$int$int$int$java_lang_Object$boolean(clipx, clipy, clipwidth, clipheight, component, enabled) {
                ...
                if ("label" === classname) {
                    ...
                    if (background == null) {
                        background = (inside !== pressed) ? this.c_hover : (pressed ? this.c_press : background);
                    }
                    else {
                        background = (inside !== pressed) ? this.c_hover : background;
                    }
                    ...
                    if (parent === false) {
                        ...
                        if (pressed || inside) {
                            this.paintRect(horizontal ? length : 0, horizontal ? bounds.height - height : length, horizontal ? this.block : width, horizontal ? height : this.block, enabled ? this.c_border : this.c_disable, (inside && !pressed && enabled) ? this.c_gradient1 : this.c_gradient2, true, true, true, true, true);
                        }
                        else {
                            this.fill(horizontal ? length : 0, horizontal ? bounds.height - height : length, horizontal ? this.block : width, horizontal ? height : this.block, true, null);
                            this.g.setColor(this.c_border);
                            this.g.drawRect(horizontal ? length : 0, horizontal ? bounds.height - height : length, horizontal ? this.block : width, horizontal ? height : this.block);
                        }
                        if (focus) {
                            this.drawFocus(0, 0, bounds.width, bounds.height);
                        }
                    ...
                    if (leftShadowDrawn) {
                        this.g.setAlpha(0.3);
                        this.g.setColor(this.c_shadow);
                        this.g.fillRect(2, 1, 6 * this.margin_1 + this.block, bounds.height - 1);
                        this.g.setAlpha(1);
                    }
                }
                else if ("bean" === classname) {
            ...
            fill(x, y, width, height, horizontal, color) {
                let c1 = this.c_gradient1;
                let c2 = this.c_gradient2;
                if (color != null) {
                    c1 = color;
                    c2 = color.darker();
                }
            ...
            handleMouse(x, y, id, button, clickcount, modifiers) {
                ...
                if ((id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$() || (id === org.shikhar.AWTMouseEvent.MOUSE_MOVED_$LI$())) || (id === org.shikhar.AWTMouseEvent.MOUSE_EXITED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_DRAGGED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_RELEASED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_CLICKED_$LI$())) {
                    const controldown = (modifiers & (org.shikhar.InputEvent.CTRL_MASK | org.shikhar.InputEvent.META_MASK)) !== 0;
                    const shiftdown = (modifiers & org.shikhar.InputEvent.SHIFT_MASK) !== 0;
            ...
            handleKey(id, keycode, keychar, modifiers, actionkey) {
                ...
                const controldown = (modifiers & (org.shikhar.InputEvent.CTRL_MASK | org.shikhar.InputEvent.META_MASK)) !== 0;
                const shiftdown = (modifiers & org.shikhar.InputEvent.SHIFT_MASK) !== 0;
                const altdown = (modifiers & org.shikhar.InputEvent.ALT_MASK) !== 0;
                this.hideTip();
                ...
                else if ((id === org.shikhar.AWTKeyEvent.KEY_PRESSED_$LI$()) && (tempKeyCode === org.shikhar.AWTKeyEvent.VK_TAB) || ((tempKeyCode === org.shikhar.AWTKeyEvent.VK_F6) && (altdown || controldown))) {
                    const outgo = true;
                ...
                if (id === org.shikhar.AWTKeyEvent.KEY_RELEASED_$LI$() && keycode === org.shikhar.AWTKeyEvent.VK_SPACE && this.mousepressed != null) {
                    if (Gui.getComponentClass(this.mousepressed) === "button") {
                        this.invoke(this.mousepressed, null, "action");
                        this.mousepressed = null;
                    }
                    else if (Gui.getComponentClass(this.mousepressed) === "checkbox") {
                        this.changeCheck(this.mousepressed, true);
                        this.mousepressed = null;
                    }
                }
                return consumed;
            ...
            handleMouseEvent(x, y, button, clickcount, shiftdown, controldown, popuptrigger, id, component, part) {
                ...
                if (("list" === classname) || ("table" === classname) || ("tree" === classname)) {
                    ...
                    if (header != null && (resizeComponent = Gui.get$java_lang_Object$java_lang_Object(header, ":resizecomponent")) != null) {
                        ...
                        if (clickcount === 2) {
                            ...
                            if (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$()) {
                                ...
                                this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.COL_RESIZE_CURSOR));
                        }
                    }
                    if (header != null && Gui.get$java_lang_Object$java_lang_Object(header, ":resizecomponent") == null) {
                        Gui.set(header, ":resizing", null);
                        this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.DEFAULT_CURSOR));
                    }
                    ...
                    if ((id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_EXITED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_RELEASED_$LI$())) {
                        ...
                        if (((this.mousepressed == null) || (this.mousepressed === component)) && ((id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$()) || (id === org.shikhar.AWTMouseEvent.MOUSE_EXITED_$LI$()))) {
                            this.setCursor(org.shikhar.Cursor.getPredefinedCursor((id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$()) ? org.shikhar.Cursor.HAND_CURSOR : org.shikhar.Cursor.DEFAULT_CURSOR));
                        }
                    ...
                    if (clickcount > 0) {
                        ...
                        this.processField$int$int$int$int$java_lang_Object$boolean$boolean$int(x, y, clickcount, id, component, true, false, 0);
                    }
                    else {
                        if (!this.processScroll$int$int$int$java_lang_Object$java_lang_Object$boolean(x, y, id, component, part, false)) {
                            this.processField$int$int$int$int$java_lang_Object$boolean$boolean$int(x, y, clickcount, id, component, true, false, 0);
                    ...
                    if (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$())
                        this.setFocus(component);
                    this.processScroll$int$int$int$java_lang_Object$java_lang_Object$boolean(x, y, id, component, part, false);
                }
                else if ("desktop" === classname) {
                    if (part === "modal") {
                        if (id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$()) {
                            this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.WAIT_CURSOR));
                        }
                        else if (id === org.shikhar.AWTMouseEvent.MOUSE_EXITED_$LI$()) {
                            this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.DEFAULT_CURSOR));
                        }
                    ...
                    if (id === org.shikhar.AWTMouseEvent.MOUSE_ENTERED_$LI$()) {
                        this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.HAND_CURSOR));
                    }
                    else if (id === org.shikhar.AWTMouseEvent.MOUSE_EXITED_$LI$()) {
                        this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.DEFAULT_CURSOR));
                    }
                    ...
                    if (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$()) {
                        ...
                        const horizontal = ("vertical" !== Gui.get$java_lang_Object$java_lang_Object(component, "orientation"));
                        this.setCursor(org.shikhar.Cursor.getPredefinedCursor(horizontal ? org.shikhar.Cursor.COL_RESIZE_CURSOR : org.shikhar.Cursor.ROW_RESIZE_CURSOR));
                    }
            ...
            processField$int$int$int$int$java_lang_Object$boolean$boolean$int(x, y, clickcount, id, component, multiline, hidden, left) {
                if (id === org.shikhar.AWTMouseEvent.MOUSE_PRESSED_$LI$() || (id === org.shikhar.AWTMouseEvent.MOUSE_RELEASED_$LI$() && clickcount > 0)) {
                    ...
                    this.setCursor(org.shikhar.Cursor.getPredefinedCursor(org.shikhar.Cursor.TEXT_CURSOR));
                }
            ...
            addAttribute(component, key, value, lasts) {
                ...
                if ("string" === definition[0]) {
                    ...
                    try {
                        const beanObject = new org.shikhar.Canvas();
                        if (beanObject != null && beanObject instanceof org.shikhar.Gui.CustomComponent) {
                            const bean = beanObject;
                            bean.setGui(this);
                            bean.setComponent(component);
                        }
                        Gui.set(component, key, beanObject);
                    }
                    catch (exc) {
                        console.error(exc.message, exc);
                        throw new java.lang.IllegalArgumentException(exc.message + value);
                    }
                }
                else
