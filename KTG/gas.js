...
var averageCollisions=0;
var averageWallCollisions=0;
function simulateGas(dt) {
  ...
  for (i = 0; i != molCount; i++) {
    ...
    if(currentTime<5){
      ...
      averageWallCollisions+= wallCollisionCount;
    }
...
function drawGas(ctx, view) {
  ...
  */
  ...
  if(currentTime>0){  
       // ctx.fillText("Inter Molecular Collision Count="+currentTime<5?averageCollisions/currentTime:averageCollisions/5,300,100);
       // ctx.fillText("Wall Molecule Collision Count="+currentTime<5?averageWallCollisions/currentTime:averageWallCollisions/5, 300,200); 
  }
